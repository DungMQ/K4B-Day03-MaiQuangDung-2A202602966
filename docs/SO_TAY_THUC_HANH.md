...
* [x] Chọn 1 chủ đề thực tế từ tệp `docs/DANH_SACH_DE_TAI.md`: **AI Email & Meeting Operations Agent**.
* [x] Điền bảng Scoring Matrix 4 tiêu chí Agentic Fit vào file `docs/trace_eval.md`.
* [x] Khai báo Tool Schema đúng chuẩn JSON Schema cho các tool (`search_emails`, `check_calendar_availability`, `schedule_meeting`) vào file `src/tools.py`.
